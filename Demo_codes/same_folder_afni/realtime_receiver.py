...
# Added for the Realtime fMRI Motion Detection Toolbox
# Developed by Brain Institute of Rio Grande do Sul - Brazil
...
class ReceiverInterface:
   ...
   def set_demo_gui(self):
      ...
      # Comment to work with the Realtime fMRI Motion Detection Tool
      #self.wx_app = wx.App()
...
def compute_TR_data(rec):
   ...
   ** Please add each data_choice to the -help.  Search for motion_norm to
   ...
   #                     --> sqrt(sum of squared motion params)
	 ...
	 # Added to work with the Realtime fMRI Motion Detection Toolbox
	 derivative = UTIL.derivative(motion,in_place=0, direct=0)
         derivative2 = UTIL.derivative(motion,in_place=0, direct=1)
         euclideanMotionDerivative = UTIL.euclidean_norm(derivative)
         euclideanMotion = UTIL.euclidean_norm(motion)
         rec.adata.mat[0][0] = len(rec.TR_data)
         rec.adata.mat[0][1] = euclideanMotionDerivative
         print 'XX - Motion: ', motion
         print 'XX - Derivative Backward: ', derivative
         print 'XX - Derivative Forward: ', derivative2
         print 'XX - euclideanMotion: ', euclideanMotion
         print 'XX - euclideanMotionDerivative: ', euclideanMotionDerivative
         rec.adata.write('motion.1D',overwrite=1)
